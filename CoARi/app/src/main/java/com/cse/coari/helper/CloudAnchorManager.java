...
public class CloudAnchorManager {
  private static final String TAG =
          com.cse.coari.activity.CloudAnchorActivity.class.getSimpleName() + "." + CloudAnchorManager.class.getSimpleName();
   ...
   * available.
   */
  public synchronized void resolveCloudAnchor(String anchorId, CloudAnchorResolveListener listener, long startTimeMillis) {
    Log.d("cloud", anchorId);
    Preconditions.checkNotNull(session, "The session cannot be null.");
